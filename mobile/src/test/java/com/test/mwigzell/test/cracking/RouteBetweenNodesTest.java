...
import com.test.mwigzell.cracking.RouteBetweenNodes;
...
public class RouteBetweenNodesTest {
    ...
    public void testExcute() {
        ...
        RouteBetweenNodes route = new RouteBetweenNodes(graph);
        boolean rc = route.execute(nodes.get(0), nodes.get(10));

        assertTrue(rc);
        LinkedList<Vertex> path = route.getPath(nodes.get(10));
